...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem 0' }}>
        <Link to="/" onClick={closeMenu} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--muted)' }}>Trusted Mobile Mechanic in Jacksonville</p>
          </div>
        </Link>
      ...
      {isMenuOpen ? (
        <div style={{ borderTop: '1px solid rgba(148, 163, 184, 0.15)', background: 'rgba(248, 250, 252, 0.98)' }}>
