  ...
  const handleChange = (
    ...
    if (name === "preferredContact") {
      ...
      setFormState((previous) => ({
        ...
        preferredContactOther:
          preferredValue === "other" ? previous.preferredContactOther : "",
      }));
      return;
    }
      ...
      <div className="container grid" style={{ gap: "3rem" }}>
        <div className="stack" style={{ gap: "1.25rem" }}>
          ...
          <p className="section__subtitle" style={{ fontSize: "1rem" }}>
            Share a few details and we&apos;ll reach out with a recommended
            repair plan, availability, and pricing options. We typically respond
            within one business hour during the day.
          </p>
          <div
            className="card"
            style={{
              background:
                "linear-gradient(135deg, rgba(37, 99, 235, 0.1), rgba(37, 99, 235, 0.25))",
            }}
          >
            ...
            >
              <li>
                We&apos;ll review your request and confirm any additional
                details we need.
              </li>
              <li>
                Receive a text or email with a diagnostic plan and upfront
                estimate.
              </li>
              <li>
                Approve the work digitally and pick a time that works around
                your schedule.
              </li>
            </ul>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="helper-text">
                You can find your VIN on your registration, insurance card, or
            ...
            <div>
              <label htmlFor="concern">
                What is your concern about your vehicle?
              </label>
              <textarea
                id="concern"
                name="concern"
            ...
            {formState.preferredContact === "other" ? (
              <div>
                <label htmlFor="preferredContactOther">
                  Tell us your preferred contact method
                </label>
                <input
            ...
            {hasSubmitted ? (
              <p className="helper-text" style={{ color: "var(--secondary)" }}>
                Thanks! We&apos;ve received your information and will reach out
                soon.
              </p>
            ) : null}
          </form>
